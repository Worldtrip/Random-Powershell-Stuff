...
$URLListFile = "C:\Users\brooaj1\URLList.txt"  
$URLList = Get-Content $URLListFile -ErrorAction SilentlyContinue 
  ...
  $result1 = Measure-Command { $request = Invoke-WebRequest -Uri $uri -Proxy http://proxy.suffolkcc.gov.uk:8080 -ProxyUseDefaultCredentials} 
